...
static std::string tabs(size_t depth) {
    std::string res = "";
...
static std::string expression_heaading(std::string text) {
    return std::string("\033[1m\033[31m") + text + "\033[0m";
}

static std::string misc_heaading(std::string text) {
    return std::string("\033[1m\033[32m") + text + "\033[0m";
}

static std::string statement_heading(std::string text) {
    return std::string("\033[1m\033[35m") + text + "\033[0m";
}

static std::string member_heading(std::string text) {
    return std::string("\033[1m\033[36m") + text + "\033[0m";
}

static std::string class_heading(std::string text) {
    return std::string("\033[1m\033[34m") + text + "\033[0m";
}

static std::string ident(std::string text) {
    return std::string("\033[1m\033[33m") + text + "\033[0m";
}

static void print(ast::TypeName type_name, size_t depth) {
    std::print("{0}{1}\n{0}{2} {3}\n{0}{4} \n", tabs(depth),
...
static void print(ast::Expression expression, size_t depth) {
    if (auto access =
...
static void print(const ast::Variable* variable, size_t depth) {
    std::print("{0}{1}\n{0}{2} \n", tabs(depth),
...
static void print(ast::Statement statement, size_t depth) {
...
static void print(ast::MemberDeclaration declaration, size_t depth) {
    if (auto method =
...
static void print(ast::Class class_, size_t depth) {
